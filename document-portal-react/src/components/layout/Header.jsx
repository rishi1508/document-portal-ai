...
const Header = () => {
 ...
 <header
 className={
 'fixed top-0 right-0 h-16 bg-dark-secondary/80 backdrop-blur-md border-b border-dark-tertiary z-40 transition-all duration-300 ' +
 (sidebarCollapsed ? 'left-20' : 'left-72')
 }
 >
 <div className="h-full px-6 flex items-center justify-between">
 {/* Left side: Brain always visible; title only when collapsed */}
 ...
 {unreadCount > 0 && (
 <span className="absolute -top-1 -right-1 bg-primary-500 text-text-primary text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
 ...
 className="w-full flex items-center gap-2 px-3 py-2 text-left text-sm text-text-secondary hover:bg-dark-hover hover:text-red-400 transition-colors group"
 >
