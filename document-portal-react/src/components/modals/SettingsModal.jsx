...
const SettingsModal = ({ isOpen, onClose }) => {
 ...
 {/* Font Size */}
 <div>
 <h3 className="text-lg font-semibold text-text-primary mb-4">Text Size</h3>
 ...
 <div className="absolute left-1 top-1 bg-dark-secondary w-4 h-4 rounded-full transition-transform peer-checked:translate-x-5"></div>
 </div>
 </label>
 </div>
 </div>
 ...
 <button
 onClick={handleSave}
 className="px-6 py-2 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-text-primary rounded-lg transition-all"
 >
 Save Changes
 </button>
 </div>
