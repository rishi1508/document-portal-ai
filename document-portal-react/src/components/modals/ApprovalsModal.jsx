                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-2 bg-green-600/20 text-green-400 rounded-lg hover:bg-green-600/30 disabled:opacity-50"
                        title="Approve"
                      >
                      ...
                      <button
                        disabled={actioning === it.requestId}
                        onClick={() => handleReject(it.requestId)}
                        className="px-3 py-2 bg-red-600/20 text-red-400 rounded-lg hover:bg-red-600/30 disabled:opacity-50"
                        title="Reject"
                      >
