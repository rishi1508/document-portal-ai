...
const Admin = () => {
 ...
 <h3 className="text-lg font-semibold text-text-primary mb-2">Pending Approvals</h3>
 <p className="text-4xl font-bold text-primary-500">3</p>
 </div>

 <div className="bg-dark-secondary border border-dark-tertiary rounded-lg p-6">
 <h3 className="text-lg font-semibold text-text-primary mb-2">Total Documents</h3>
 ...
 <div className="bg-dark-secondary border border-dark-tertiary rounded-lg p-6">
 <h2 className="text-xl font-semibold text-text-primary mb-4">Recent Document Uploads</h2>
